...
try:
    ...
    # If dependency_injector is not installed, skip these tests
    pytest.skip("dependency_injector not installed, skipping w_depinject tests")
except Exception as e:
    # Catch any other exceptions that might occur during import or setup
    pytest.fail(f"An error occurred while setting up w_depinject tests: {e}")
else:
    # If everything is fine, we can run the tests
